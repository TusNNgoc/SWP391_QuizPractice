                            ...
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach var="quiz" items="${quizzes}">
                                            <tr>
                                                ...
                                                <td> 
                                                    <a href="updatequiz?quiz_id=${quiz.quiz_id}" class="update-btn">
                                                        <i class="fas fa-edit"></i> Update
                                                    </a>

                                                </td>
                                                <td> 
                                                    <a href="delete_quiz.jsp?quiz_id=${quiz.quiz_id}" class="delete-btn">
                                ...
                                <div >
                                    <button type="button" class="btn btn-outline-success">
                                        <div><h3> <a href="add_quiz.jsp" style="margin-top: 5px;
                                                     margin-right: 20px;
                                                     margin-bottom: 15px;
                                                     margin-left: 10px;">  Add Quiz  </a></h3></div>
                                    </button>
                                </div
