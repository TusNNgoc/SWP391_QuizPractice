                ...
                <main>
                    <div class="container mt-5">
                        ...
                        <form action="updatequestion" method="post">
                            <input type="hidden" name="questionId" value="${questionInfo[0]}">

                            <tr>
                                <td>Question</td>
                                <td> <input value="${questionInfo[1]}" type="text" class="form-control" id="quizName" name="quizName" required></td>
                            </tr>

                            <br><!-- comment -->
                            <label for="role">Level</label>
                            <select id="role" name="role">
                                <option value="1" ${questionInfo[2] == 1 ? 'selected' : ''}>Easy</option>
                                <option value="2" ${questionInfo[2] == 2 ? 'selected' : ''}>Normal</option>
                                <option value="3" ${questionInfo[2] == 3 ? 'selected' : ''}>Hard</option>
                            </select>
                    </div>
                    <br><!-- comment -->
