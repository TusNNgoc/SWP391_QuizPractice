...
<html lang="en">
    <head>
        ...
        <title>Update Quiz - SB Admin</title>
                    ...
                    <div class="container mt-5">
                        ...
                        <form action="updatequiz" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="quizName" name="quizName" value="${quiz.quiz_name}" required>
                            </div>
                            <div class="form-group">
                                <label for="quizContent">Quiz Content:</label>
                                <textarea class="form-control" id="quizContent" name="quizContent" rows="4" required>${quiz.quiz_content}</textarea>
                            </div>
