                                ...
                                <div class="e-profile">
                                    ...
                                    <div class="tab-content pt-3">
                                        <div class="tab-pane active">
                                            <form class="form" novalidate action="profile" method="post">
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" type="text" name="fullname"
                                                                        placeholder="John Smith" value="${user.fullname}">
                                                                </div>
                                                            </div>
                                                            <div class="col">
                                                                <div class="form-group">
                    ...
                    <div class="col-12 col-md-3 mb-3">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <button type="button" class="btn btn-primary">Back to Teacher Home</button>
                            </div>
                        </div>
                    </div>
                </div>
