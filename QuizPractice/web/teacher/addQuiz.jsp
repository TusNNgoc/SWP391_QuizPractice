...
<html lang="en">
    ...
    <body>
        <div class="container">
            <h2>Add Quiz</h2>
            <form action="/QuizPractice/addQuiz" method="post" >
                ...
                <div class="form-group">
                    <label for="questionText">Quiz Name:</label>
                    <input type="text" class="form-control" id="questionText" name="quiz_name" required>
                </div>
                <div class="form-group">
                    <label for="questionText">Quiz Content:</label>
                    <input type="text" class="form-control" id="questionText" name="quiz_content" required>
                </div>

                <div class="form-group">
                    <label for="quizId">Belong to Course:</label>
               
                    <input type="text" class="form-control" id="questionText" name="course_name" value="${sessionScope.courseName}" readonly>
                </div>
