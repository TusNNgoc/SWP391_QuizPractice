    ...
    <head>
      ...
      <div class="container">
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="background-color: #e3f2fd;">
          ...
          <a class="navbar-brand" href="index.html"><h4><i></i>Quizz</h4></a>
  ...
  <!----------------------------------------Navbar End------------------------------------------------------->
      ...
      <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
              <img src="./img/quiztime.png" class="d-block w-100" height="500px">
          </div>
        </div>
      </div>
      </div>
      ...
      <div class="row pt-3">
          <div class="card col-sm" style="border-style: none;">
            <a href="Mae.html" style="text-decoration:none">
            <img src="./img/mae101.png" class="card-img-top" height="250px" style="border-style:solid;border-color:black;"></a>
            <div class="card-body">
              <h5 class="card-title">MAE101</h5>
              ...
              <a href="Mae.html" class="btn btn-primary">Take Quiz</a>
            </div>
          </div>
      
          <div class="card col-sm" style="border-style: none;">
            <a href="Cea.html" style="text-decoration:none">
            <img src="./img/cea201.png" class="card-img-top" height="250px" style="border-style:solid;border-color:black;"></a>
            <div class="card-body">
              <h5 class="card-title">CEA201</h5>
              <p class="card-text">Take Mathematics Quiz to test and sharpen your algebra, arithmetic, geometry and 
              other mathematical concepts.</p>
              <a href="Cea.html" class="btn btn-primary">Take Quiz</a>
            </div>
          </div>
          
          <div class="card col-sm" style="border-style: none;">
            <a href="Ssl.html" style="text-decoration:none">
            <img src="./img/ssl101.png" class="card-img-top" height="250px" style="border-style:solid;border-color:black;"></a>
            <div class="card-body">
              <h5 class="card-title">SSL101</h5>
              ...
              <a href="Ssl.html" class="btn btn-primary">Take Quiz</a>
            </div>
          </div>
