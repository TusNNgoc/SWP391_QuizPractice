    ...
    <body>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="background-color: #e3f2fd;">
                ...
                <a class="navbar-brand" href="index.html"><h4><i>Quizz</i></h4></a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <!--	        <li class="nav-item">
                                          <a class="nav-link" href="signinOfficial.jsp">login</a>
                        ...
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item">
                                <button type="button" class="btn btn-secondary mr-2 mb-1" data-toggle="modal" 
                                        data-target="#LoginModal" onclick=redirectToLogin()>
                                    Login</button>
                                <!--------------------------------------Login Modal------------------------------------------------>
                                ...
                                <script>
                                    function redirectToLogin() {
                                        // Chuy?n h??ng ??n servlet v?i courseId
                                        window.location.href = "signinOfficial.jsp";
                                    }
                                </script>
                            ...
                            <li class="nav-item">
                                <button type="button" class="btn btn-outline-info" data-toggle="modal" data-target="#RegisterModal" onclick=redirectToRegister()>
                                    Register</button>
                                                ...
                                                <form action="register.jsp" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="exampleInputUniv" aria-describedby="UnivHelp" 
                                                               placeholder="FPT UNIVERSITY" name="univ" readonly>
                                                    </div>
                    ...
                    <script>
                        function redirectToRegister() {
                            // Chuy?n h??ng ??n servlet v?i courseId
                            window.location.href = "signupOfficial.jsp";
                        }
                    </script>
                    <!----------------------------------------End of Nav2----------------------------------------------->  
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <a href="Quiz.jsp">
                            <img src="assets/img/lets-take-a-quiz.jpg" class="d-block w-100" alt="Take A Quiz" height="500px" width="200px">
                        </a>
                    </div>
                    ...
                    <div class="carousel-item">
                        <a href="Classroom.jsp">
                            <img src="assets/img/takequiz2.png" class="d-block w-100" alt="My Classroom" height="500px" width="200px">
                        </a>
                    </div>
                </div>
