...
<head>
    ...
    <%-- Check if the session attribute "start" is null --%>
...
<div class="container px-10 ">
    <div style="margin-top: 75px; ">
        ...
        <div class="float-right"><h4>Time Left: <span id="countdown">8</span>s</h4></div>
    </div>
    <br>
    ...
    <div class="container my-3" style="color:rgb(54,151,233);">
        <div class="row">
            <div class="col-6 pl-2 pr-1">
                <div class="px-3 pt-3 pb-3" id="a" onmouseover="myfunc('a')" onmouseout="myfunc2('a')"
                     onclick="myfunc3('a')" style="background-color: rgb(235,235,235);">
                    <h5><%= session.getAttribute("mya") %></h5></div>
            </div>

            <div class="col-6 pl-2 pr-1">
                <div class="px-3 pt-3 pb-3" id="b" onmouseover="myfunc('b')" onmouseout="myfunc2('b')"
                     onclick="myfunc3('b')" style="background-color: rgb(235,235,235);">
        ...
        <div class="row my-3">
            <div class="col-6 pl-2 pr-1">
                <div class="px-3 pt-3 pb-3" id="c" onmouseover="myfunc('c')" onmouseout="myfunc2('c')"
                     onclick="myfunc3('c')" style="background-color: rgb(235,235,235);">
                    <h5><%= session.getAttribute("myc") %></h5></div>
            </div>

            <div class="col-6 pl-2 pr-1">
                <div class="px-3 pt-3 pb-3" id="d" onmouseover="myfunc('d')" onmouseout="myfunc2('d')"
                     onclick="myfunc3('d')" style="background-color: rgb(235,235,235);">
