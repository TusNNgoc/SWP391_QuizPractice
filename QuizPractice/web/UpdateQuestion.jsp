        ...
        <div class="container">
            ...
            <form action="quizcrud" class="form" method="POST">
                ...
                <div class="text-center">
                    ...
                    <a href="/QuizPractice" class="btn btn-light float-right" style="text-decoration: none;" role="button" aria-pressed="true"><span style="text-decoration: none;">Hủy</span></a>
                </div>
