                                ...
                                <form action="quizcrud" class="form" method="POST">
                                    <div class="row justify-content-center">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label for="typelist" class="form__label">Type</label>
                                                ...
                                                <c:forEach var="answer" items="${answers}">
                                                    <c:if test="${count == 0}">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="rightanswer" name="rightanswer" value="${answer.answer_text}" required/>
                                                        </div>
                                                            <input type="hidden" name="answerid0" value="${answer.answer_id}"/>
                                                    </c:if>
                                                    <c:if test="${count == 1}">
                                                        <div class="form-group">
                                                            <label for="wronganswer1" class="form__label">Wrong Answer 1</label>
                                                            <input type="text" class="form-control" id="wronganswer1" name="wronganswer1" value="${answer.answer_text}" required/>
                                                        </div>
                                                            <input type="hidden" name="answerid1" value="${answer.answer_id}"/>
                                                    </c:if>
                                                    <c:if test="${count == 2}">
                                                        <div class="form-group">
                                                            <label for="wronganswer2" class="form__label">Wrong Answer 2</label>
                                                            <input type="text" class="form-control" id="wronganswer2" name="wronganswer2" value="${answer.answer_text}" required/>
                                                        </div>
                                                            <input type="hidden" name="answerid2" value="${answer.answer_id}"/>
                                                    </c:if>
                                                    <c:if test="${count == 3}">
                                                        <div class="form-group">
                                                            <label for="wronganswer3" class="form__label">Wrong Answer 3</label>
                                                            <input type="text" class="form-control" id="wronganswer3" name="wronganswer3" value="${answer.answer_text}" required/>
                                                        </div>
                                                            <input type="hidden" name="answerid3" value="${answer.answer_id}"/>
                                            ...
                                            <div class="text-center">
                                                ...
                                                <a href="/QuizPractice" class="btn btn-light ml-2" style="text-decoration: none;">Hủy</a>
                                            </div>
