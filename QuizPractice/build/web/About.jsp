	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="background-color: #e3f2fd;">
	    ...
	    <ul class="navbar-nav mr-auto">
	      ...
	      <!------------------------------------My Classroom-------------------------------------------------->
	        ...
	        <li class="nav-item">
	          <a class="nav-link" href="Classroom.jsp">MyCourses</a>
	        </li>
...
<!---------------------------------------Side Div--------------------------------------------------------->
  <div class="col-md-4">
    ...
    <div class="px-5">
    <img src="img/" class="card-img-top" height="270px" style="border-radius:50%; border-style:solid">
    </div>
    <div class="card-body">
      <h5 class="card-title">About Me</h5>
      <p class="card-text">Hello.
      We've used HTML, CSS, JavaScript, Bootstrap, Core Java, JSP and Java JDBC to create this website.
         
      <p><h6>My Email:</h6><a href="https://mail.google.com/mail/">Group6@gmail.com</a></p>
